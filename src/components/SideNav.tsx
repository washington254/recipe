...
const SideNav = () => {
  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 h-full bg-white md:border-r md:border-gray-50 shadow-[0_4px_30px_rgba(0,0,0,0.05)] md:shadow-none flex flex-col items-center w-[300px] py-10 transition-transform duration-300 ease-in-out z-50 overflow-y-auto ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        
        {/* Logo Section */}
        <div className="w-full flex justify-center mb-8">
           <h1 className="font-logo text-[4rem] font-bold  text-[#111] tracking-tight antialiased">Chefie</h1>
        </div>

        {/* Profile Section */}
        <div className="flex flex-col items-center mb-10 px-4 w-full">
            ...
            <h2 className="text-[1.35rem] font-semibold text-gray-900 font-serif tracking-wide text-center">Theresa Webb</h2>
            <p className="text-[0.95rem] text-gray-500 font-medium mt-1">Master Chef</p>
        </div>
            
        {/* Navigation Links */}
        <ul className="flex flex-col w-full px-8 gap-[16px]">
            {/* Recipes - Active State */}
            <li>
                <a href="#" className="flex items-center gap-4 bg-[#ffb703] text-black rounded-xl py-[14px] px-5 font-semibold text-[15px] shadow-[0_8px_20px_rgba(255,183,3,0.35)] transition-transform duration-200 hover:scale-[1.03]">
            ...
            {/* Favorites */}
            <li>
                <a href="#" className="flex items-center gap-4 bg-white border border-gray-100 rounded-xl py-[14px] px-5 font-medium text-gray-400 text-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.03)] transition-all duration-200 hover:border-gray-200 hover:bg-gray-50 hover:text-gray-700 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]">
